...
/** 档案审核状态机 */
export const PROFILE_STATUS_TRANSITIONS: TransitionMap<ProfileStatus> = {
...
/** 牵线状态机 */
export const INTRODUCTION_STATUS_TRANSITIONS: TransitionMap<IntroductionStatus> = {
...
/** 提现单状态机 */
export const WITHDRAWAL_STATUS_TRANSITIONS: TransitionMap<WithdrawalStatus> = {
...
export const INTRODUCTION_TERMINAL_STATUSES: readonly IntroductionStatus[] = [
  IntroductionStatus.SUCCESS,
  IntroductionStatus.FAILED,
  IntroductionStatus.CANCELLED,
];
...
export function nextStatuses<T extends string>(map: TransitionMap<T>, from: T): readonly T[] {
  return map[from] ?? [];
}
