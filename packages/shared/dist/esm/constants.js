...
/** 牵线流程的主干顺序，前端画步骤条用 */
export const INTRODUCTION_FLOW_STEPS = [
...
export const RESET_CYCLE_LABEL = {
    [ResetCycle.NONE]: '不重置',
...
export const MATCH_WEIGHT_LABEL = {
