...
exports.LOCKED_PLACEHOLDER = exports.ANONYMOUS_VIEWER = void 0;
exports.resolveViewerLevel = resolveViewerLevel;
exports.canSee = canSee;
exports.maskName = maskName;
exports.maskPhone = maskPhone;
exports.maskAccount = maskAccount;
exports.maskIdCard = maskIdCard;
exports.maskOrg = maskOrg;
exports.lockedValue = lockedValue;
exports.isMaskedValue = isMaskedValue;
const enums_1 = require("./enums");
exports.ANONYMOUS_VIEWER = {
    userId: null,
    isSelf: false,
    isAdmin: false,
 ...
 */
function resolveViewerLevel(ctx) {
    if (ctx.isAdmin)
        return enums_1.VisibilityLevel.ADMIN;
    if (ctx.isSelf)
        return enums_1.VisibilityLevel.ADMIN; // 本人看自己等于全可见
    if (ctx.isMatchmakerOf)
        return enums_1.VisibilityLevel.MATCHMAKER;
    if (ctx.isUnlocked)
        return enums_1.VisibilityLevel.UNLOCKED;
    if (ctx.isVip)
        return enums_1.VisibilityLevel.VIP;
    if (ctx.userId)
        return enums_1.VisibilityLevel.MEMBER;
    return enums_1.VisibilityLevel.PUBLIC;
}
function canSee(viewerLevel, fieldLevel) {
...
exports.LOCKED_PLACEHOLDER = {
    [enums_1.VisibilityLevel.PUBLIC]: '',
    [enums_1.VisibilityLevel.MEMBER]: '登录后可见',
    [enums_1.VisibilityLevel.VIP]: '开通 VIP 可见',
    [enums_1.VisibilityLevel.UNLOCKED]: '解锁后可见',
    [enums_1.VisibilityLevel.MATCHMAKER]: '仅红娘可见',
    [enums_1.VisibilityLevel.ADMIN]: '不可见',
};
function lockedValue(level, preview) {
    return {
        locked: true,
        requiredLevel: level,
        hint: exports.LOCKED_PLACEHOLDER[level],
        ...(preview ? { preview } : {}),
    };
}
