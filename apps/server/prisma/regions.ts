...
/**
 * 弱别名：只有整条文本一个地名都匹配不上时才生效。
 *
 * 这些词本身不唯一指向某地——"万达"全国都是，"老家"更是个通用词。
 * 但在这批存量客户的语境里，填这两个词的人说的就是辛集。
 * 单独分一档是怕它们参与正常匹配时抢跑：
 * 将来遇到"老家保定，现居石家庄"，按"先出现的地名优先"会判成辛集，那就错了。
 */
export const REGION_WEAK_ALIASES: Record<string, string> = {
  万达: '130181',
  老家: '130181',
};
